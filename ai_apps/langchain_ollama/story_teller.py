...
print(
    get_results(llm=llm, prompt=prompt, input_params={"length": "short",
                                                       "genre": "horror",
                                                       "text": "Once there was a coder"})
)
print(get_results(llm=llm, prompt=prompt, input_params={"length": "short",
                                                        "genre": "rom-com",
                                                        "text": "And the Queen died"}))
